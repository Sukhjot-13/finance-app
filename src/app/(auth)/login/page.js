          ...
          <form className="space-y-6" onSubmit={handleVerifyOtp}>
            <div>
              ...
              <input
                ...
                className="w-full text-center tracking-[1em] px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="______"
              />
            </div>
            <button
